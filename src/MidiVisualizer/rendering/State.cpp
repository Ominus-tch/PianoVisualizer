...
void State::defineOptions(){
	...
	_sharedInfos[s_flashes_fade_key] 			= {Category::FLASHES, s_flashes_fade_dsc, Type::FLOAT, {0.f, 3.0f}};
...
void State::updateOptions(){
	...
	_floatInfos[s_flashes_fade_key] = &flashes.fadeTime;
...
void State::reset(){
	...
	ID3D11ShaderResourceView* blankID = ResourcesManager::getTextureFor("blankarray");
